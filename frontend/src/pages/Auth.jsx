                ...
                <div className="flex justify-center gap-2">
                  {twoFactorCode.map((data, index) => (
                    <input key={index} type="text" maxLength="1" value={data}
                      ...
                      className="w-10 h-12 text-center text-xl font-black rounded-xl bg-white/5 border border-white/20 text-white outline-none focus:border-blue-500 focus:bg-white/10 transition-all shadow-inner"
                    />
                  ))}
                </div>
